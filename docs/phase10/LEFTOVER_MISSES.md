...
- `cart_ntm_crate` — no CE item png under any remap of existing files
- `cart_ntm_destroyer` — no CE item png under any remap of existing files
- `cart_ntm_ore` — no CE item png under any remap of existing files
- `cart_ntm_powder` — no CE item png under any remap of existing files

...
| | |
|---|---|
| **Weighted** (Σport / ΣCE) | **101.3%** (7871 / 7767) |
| **Unweighted** (mean of category %) | **101.5%** |
| Recipe/loot reachability of port items | **53.0%** (1341 / 2529) |
...
Largest remaining holes: **blocks 204**, **machine 327**, **vanilla 52**.
Weighted **101.3%**. Category holes remain. Not content-complete.
...
|---|---:|---:|---:|---|
| Items (flattened ids) | 1863 | 2529 | **135.7%** | Extract + already-registered helpers / loops + Dummyable BlockItems |
| Blocks | 1169 | 965 | **82.5%** | +UF6/PuF6/funnel/microwave/electric furnace/detector/orbus TE + 5 deco |
...
**53.0%** (1341 / 2529). Prior: 1341 / 2517 (53.3%).

## Next single gap

Blocks **82.5%** (204 missing — Dummyable/deco leftover, not dummy regs).
Machine leftover **~327** (ChemPlant / SILEX / StorageDrum / SuperComputer I/O unregistered).
Vanilla leftover **52**. Weighted **101.3%**. `v0.0.1-rc2` stays (no new tag).

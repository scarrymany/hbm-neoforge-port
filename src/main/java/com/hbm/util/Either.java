...
public final class Either<L, R> {
    ...
    public <T> T run(java.util.function.Function<L, T> leftFunc, java.util.function.Function<R, T> rightFunc) {
        return isLeft ? leftFunc.apply((L) value) : rightFunc.apply((R) value);
    }

    public <T> T runLeftOrNull(java.util.function.Function<L, T> func) {
        return isLeft ? func.apply((L) value) : null;
    }

    public <T> T runRightOrNull(java.util.function.Function<R, T> func) {

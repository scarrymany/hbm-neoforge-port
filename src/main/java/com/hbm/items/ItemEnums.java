...
/**
 * Pure-data enums ported verbatim from CE. None of these carry item logic or Minecraft/NeoForge
 * types, so nothing here changes for the NeoForge port; Phase 1 item classes reference these the
 * same way CE's ModItems and item classes do.
 */

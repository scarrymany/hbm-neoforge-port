...
/**
 * Ported from CE's {@code com.hbm.explosion.ExplosionSolinium} (110 lines, read in full) - the
 * "blue rinse" column-carving variant {@code EntityNukeExplosionMK3} picks for {@code extType == 1}.
 * Delegates each block to {@link ExplosionNukeGeneric#solinium} - see that method's javadoc for the
 * ModBlocks-registration gaps it documents.
 */
    ...
    private void breakColumn(int x, int z) {
        ...
        if (dist > 0) {
            ...
            for (int y = (int) (dist / this.explosionCoefficient2); y > -dist / this.explosionCoefficient; y--) {
                ...
                ExplosionNukeGeneric.solinium(this.levelObj, pos);
            }
        }
    }
}

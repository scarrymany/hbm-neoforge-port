...
public class Fluids {
    ...
    public static void init() {
        ...
        // NOTE: CE also wires FT_Toxin onto CHLORINE/PHOSGENE/MUSTARDGAS/ESTRADIOL/REDMUD here, referencing
        // com.hbm.lib.ModDamageSource, com.hbm.potion.HbmPotion and com.hbm.util.ArmorRegistry.HazardClass.
        // Those classes are not part of this phase (fluid type registry); FT_Toxin itself is fully ported
        // and ready, but the fluid-to-toxin assignment is left for whichever phase ports those three classes.

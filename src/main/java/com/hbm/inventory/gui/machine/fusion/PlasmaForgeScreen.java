...
public class PlasmaForgeScreen extends GuiInfoContainer<PlasmaForgeMenu> {

    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("hbm", "textures/gui/reactors/gui_fusion_plasmaforge.png");

    public PlasmaForgeScreen(PlasmaForgeMenu menu, Inventory inventory, Component title) {
    ...
    protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        drawCustomInfo(guiGraphics, mouseX, mouseY, 8, 20, 140, 10,
                Component.literal(be.isProcessing ? "Forging" : "Idle"),

...
/** CE {@code GUIFirebox} for the brick oven. */
public class HeaterOvenScreen extends GuiInfoContainer<HeaterOvenMenu> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(MainRegistry.MODID, "textures/gui/machine/gui_heating_oven.png");

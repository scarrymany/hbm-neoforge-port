...
public class PaPartScreen extends GuiInfoContainer<PaPartMenu> {

    public PaPartScreen(PaPartMenu menu, Inventory inventory, Component title) {
    ...
    protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        drawCustomInfo(guiGraphics, mouseX, mouseY, 8, 20, 160, 10,
                Component.literal("PA " + be.kind.name()),
                Component.literal("Coil + battery"));
    }
}

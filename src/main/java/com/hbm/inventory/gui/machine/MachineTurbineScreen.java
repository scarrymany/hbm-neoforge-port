...
/**
 * Ported (visually, from CE's {@code GUIMachineTurbine}) as a plain panel - see
 * {@link MachineRTGScreen}'s javadoc for the no-texture-yet rationale. Purely passive - both tanks
 * render via {@link com.hbm.inventory.fluid.tank.FluidTankNTM#renderTank}, no buttons.
 */

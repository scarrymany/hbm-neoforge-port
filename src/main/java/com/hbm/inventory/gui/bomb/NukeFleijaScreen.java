...
public class NukeFleijaScreen extends GuiInfoContainer<NukeFleijaMenu> {

    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("hbm", "textures/gui/weapon/fleijaschematic.png");

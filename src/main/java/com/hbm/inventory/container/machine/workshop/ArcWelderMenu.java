...
/**
 * Exact CE {@code ContainerMachineArcWelder.java:35-46}: 3 in + out + battery + fluid ID +
 * upgrades 6-7 at 89,63 / 107,63. {@code setType(5)} Exact CE
 * {@code TileEntityMachineArcWelder.java:121}.
 */
public class ArcWelderMenu extends MenuBase<ArcWelderBlockEntity> {
    ...
    public ArcWelderMenu(int id, Inventory playerInv, ArcWelderBlockEntity be) {
        ...
        this.addSlot(new SlotNonRetarded(tile, 6, 89, 63));
        this.addSlot(new SlotNonRetarded(tile, 7, 107, 63));
